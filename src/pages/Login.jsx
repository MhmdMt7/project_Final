        ...
        <div className="w-full h-full flex items-center justify-start    absolute inset-0 bg-cover bg-center "
            ...
            <div className='  lg:w-[50%] h-full flex justify-center items-center '>
                <Formik initialValues={{ email: '', password: '' }} validationSchema={validationSchema} onSubmit={handleSubmit}>
                    <Form className="relative w-[70%] h-[70%] p-2.5 rounded-2xl bg-black/50 from-white/20 via-white/10 to-transparent shadow-[0_0_40px_rgba(255,255,255,0.15)] grid grid-cols-1 items-center">
                        <div className=''>
